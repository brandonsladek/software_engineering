...
/** We did not make any changes to this class since all of the methods involved using standard console i/o. We essentially
 * ported the behavior of these methods (convertDirection, choosePickupItem, chooseDropItem, and startQuest) into
 * AdventureGameModelFacade, AdventureGameView, GrabView, DropView. Our implementations of this logic took less lines than
 * this file since we didn't have to do as much input checking since the user only has the option of pressing available
 * buttons. */
public class AdventureGame {
  ...
  public void startQuest() throws IOException {
   ...
   // startRm gets set to "outside" here
       ...
       System.out.println("You are carrying: " + thePlayer.showMyThings() + '\n');
	    ...
	    // Go
	     ...
	     case 'u': case 'U': case 'd': case 'D':
                ...
                // Here is where the player actually moves a direction
                /** This is the only place in the entire class where we made a change (only adding a print call so the
                 * terminal standard console i/o implementation will still run smoothly.*/
...
public static void main(String args[]) throws IOException {
    ...
    System.out.println("Welcome to the Adventure Game,\nwhich is inspired by an old game called the Colossal Cave " +
